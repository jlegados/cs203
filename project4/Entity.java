...
public abstract class Entity {
    ...
    //new entities
    public static final String IRONMANBALL_KEY = "IronManBall";
    public static final String IRONMAN_KEY = "IronMan";
    public static final int IRONMAN_ACTION_PERIOD = 1;
    public static final int IRONMAN_ANIMATION_PERIOD = 0;
    public static final int IRONMAN_NUM_PROPERTIES = 2;
    public static final String THANOS_KEY = "Thanos";
    public static final int THANOS_ANIMATION_PERIOD = 0;
    public static final int THANOS_ACTION_PERIOD = 1;
